...
const AdminJobsTable = () => {
  ...
  return (
    <div className="overflow-x-auto">
      <Table>
        <TableCaption className="text-center">A list of your recent posted jobs</TableCaption>
        <TableHeader>
          <TableRow>
            <TableHead className="text-gray-700 whitespace-nowrap">Company Name</TableHead>
            <TableHead className="text-gray-700 whitespace-nowrap">Role</TableHead>
            <TableHead className="text-gray-700 whitespace-nowrap">Date</TableHead>
            <TableHead className="text-right text-gray-700 whitespace-nowrap">Action</TableHead>
          </TableRow>
        </TableHeader>
